...
$(document).ready(function() {
    ...
    function a() {
        return {
            ...
            layout: { padding: { left: 10, right: 0, top: 15, bottom: 0 } }
        };
    }
    function r(e, a, r) {
        return (
  ...
  /*   var l = document.getElementById("update-chart-1").getContext("2d"),
        l =
            (new Chart(l, {
                type: "bar",
                data: e("#fff", [25, 30, 20, 15, 20], "#fff"),
                options: a()
            }),
            document.getElementById("update-chart-2").getContext("2d")),
        l =
            (new Chart(l, {
                type: "bar",
                data: e("#fff", [10, 30, 20, 15, 30], "#fff"),
                options: a()
            }),
            document.getElementById("update-chart-3").getContext("2d")),
        l =
            (new Chart(l, {
                type: "bar",
                data: e("#fff", [25, 10, 20, 15, 20], "#fff"),
                options: a()
            }),
            document.getElementById("update-chart-4").getContext("2d"));
    new Chart(l, {
        type: "bar",
        data: e("#fff", [25, 30, 20, 15, 10], "#fff"),
        options: a()
    }); */
    $(function() {
        function e() {
            a.zoomToIndexes(
                Math.round(0.4 * a.dataProvider.length),
                Math.round(0.55 * a.dataProvider.length)
            );
        }
        var a = AmCharts.makeChart("sales-analytics", {
            type: "serial",
            theme: "light",
            marginTop: 0,
            marginRight: 0,
            ...
            valueAxes: [{ axisAlpha: 0, gridAlpha: 0, position: "left" }],
            graphs: [
                {
                    id: "g1",
                    balloonText:
        ...
        a.addListener("rendered", e), a.zoomChart && a.zoomChart();
    });
    var l = document.getElementById("app-sale1").getContext("2d"),
        l =
            (new Chart(l, {
                type: "line",
                data: r(
                    "#11c15b",
                    [1, 15, 30, 15, 25, 35, 45, 20, 25, 30],
                    "transparent"
                ),
                options: t()
            }),
            document.getElementById("app-sale2").getContext("2d")),
        l =
            (new Chart(l, {
                type: "line",
                data: r(
                    "#448aff",
                    [45, 30, 25, 35, 20, 35, 45, 20, 25, 1],
                    "transparent"
                ),
                options: t()
            }),
            document.getElementById("app-sale3").getContext("2d")),
        l =
            (new Chart(l, {
                type: "line",
                data: r(
                    "#ff5252",
                    [1, 45, 24, 40, 20, 35, 10, 20, 45, 30],
                    "transparent"
                ),
                options: t()
            }),
            document.getElementById("app-sale4").getContext("2d"));
    new Chart(l, {
        type: "line",
        data: r(
            "#536dfe",
            [1, 15, 45, 15, 25, 35, 45, 20, 25, 30],
            "transparent"
        ),
        options: t()
    });

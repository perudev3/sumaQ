                                          ...
                                          <div class="row">
                                              <div class="col-lg-4">
                                                  <div class="form-group">
                                                      <label for="">Compra solicitada por:</label>
                                          ...
                                          <div class="row">
                                              <div class="col-lg-6">
                                                  <div class="row">
                                                      <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label for="">Fecha prevista de llegada</label>
                                                                <input type="date" class="form-control" v-model="preview_arrival_date">
                                                            </div>
                                                      </div>
                                                      <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label for="">Observaciones de la compra</label>
                                                                <textarea rows="5"  v-model="purchase_orders_observation" class="form-control"></textarea>
                                                            </div>
                                                      </div>
                                                  </div>
                                              </div>

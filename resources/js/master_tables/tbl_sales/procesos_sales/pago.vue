                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                                <span class="input-group-text"  id="basic-addon1">Pagará con:</span></div>
...
export default {
	...
	methods:{
        ...
        finish(){
			this.$router.push({name: "sales/finish_sales",  params: {data_pedidos: this.data_pedidos , data_customer: this.data_customer}})
		},
    ...
    computed:{
        saldo_restante(){
           return  this.pagar_billete - this.total;
        }
    },
    watch: {

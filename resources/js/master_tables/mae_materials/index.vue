							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 pull-right">
									<div class="form-group tg-inputwithicon">
										...
										<input type="search" class="form-control" placeholder="Nombre del Material"  v-model="materials_name" v-on:keyup="searchMaterials">
									</div>
								</div>
							</div>
						</div>
	                    ...
	                    <div class="card-footer" style="background-color: rgb(0 0 0 / 0%) !important;border-top: 1px solid rgb(255 255 255 / 13%) !important;">
	                        <nav aria-label="Page navigation" class="float-left">
	                            ...
	                            <!--Botones anteriores-->
	                                ...
	                                <li v-for="(page,index) in getLinksPages" class="page-item" :class="[page === isCurrentPage ? 'active':'' ]" :key="page">

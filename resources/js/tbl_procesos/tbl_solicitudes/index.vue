                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <router-link to="/solicitudes/create">
                                                ...
                                                <section>
                                                    <div class="wizard-form wizard clearfix" id="basic-forms">
                                                        <div class="steps clearfix">
                                                            <ul role="tablist">
                                                            <li style="width: 50% !important;" role="tab" class="first current" aria-disabled="false" aria-selected="true" align="center">
...
export default {
  ...
  methods:{
        ...
        GetSolicitudes(){
              	let me=this;
              	axios.get('/get_solicitudes').then(function(response){

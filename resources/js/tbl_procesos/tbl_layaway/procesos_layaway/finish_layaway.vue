                                                                                ...
                                                                                <div class="table-responsive">	
                                                                                    <table class="table">
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                <th class="price totales both_border" colspan=3>CANCELADO : $ {{ total_cancel_layaway }}</th>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <th class="price totales both_border" colspan=3>SALDO : $ {{ totalPrice - total_cancel_layaway }}</th>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                </div>
...
export default {
	...
	data:function(){
	    return {
            ...
            total_cancel_layaway: this.$route.params.total_cancel_layaway,
            hoy: new Date(),  
            fecha:'',
            pagar_billete:'',            
            customers_name:'',
	...
	methods:{
        ...
        getPedidos(data_pedidos) {
            let me = this;
            axios
                .post("/layaway_get_products_pedidos", { data_pedidos: data_pedidos })
        ...
        Pagar(){
            ...
            axios.post('/layaway_post_pago_efectivo',{
                ...
                'layaway_payment_method' : me.methodpage,
                'layaway_payment_date' : me.fecha,
                'data_pedidos' : me.data_pedidos,
                'total_cancel_layaway':me.total_cancel_layaway,
                'total_bussines_layaway': me.totalPrice,
			}).then(function(response){
                if (response.data.status=='success') {
                    swal.close();
                    JSON.parse(localStorage.getItem('array_pedidos'));
                    localStorage.clear();
                    this.$router.replace('/layaway/pedidos');
                }				
          	});
        },
